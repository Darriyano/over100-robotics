<script lang="ts">
    ...
    import {fetchRobotsData, sendDirectionData} from "../../api";
...
<div class="page-container">
    ...
    <div class="console">
        ...
        <div class="map-buttons">
            <button on:click={() => a('left')} class="map-direction-button" id="map-direction_button_left">
                <svg
                        width="32"
                        height="27"
                        viewBox="0 0 32 27"
            ...
            <button on:click={() => a('down')} class="map-direction-button" id="map-direction_button_down">
                <svg
                        width="27"
                        height="32"
                        viewBox="0 0 27 32"
            ...
            <button on:click={() => a('right')} class="map-direction-button" id="map-direction_button_right">
                <svg
                        width="31"
                        height="28"
                        viewBox="0 0 31 28"
